# Damn Vulnerable Drone Patched

This is a patched fork of the `Damn Vulnerable Drone` repository so I can try my hand at not only exploiting the vulnerabilities present in this project, but also fixing them.
